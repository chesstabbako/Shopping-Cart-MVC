            ...
            <?php for($i=0; $i<count($data["items"][0]);$i++){ ?> 
                  ...
                  <div class="item">
                        ...
                        <?php if(isset($_SESSION['user'])){ ?>
                             ...
                             <form action="index.php?c=cart&a=rate_item"
                              method="post" 
                              class="for-rate for-rate<?php echo $data["items"][0][$i]['id'];?>" 
                              id="for-rate">
                              
                              <div> 
                              
                                <input type="hidden" name="id_item"
                                value="<?php echo $data["items"][0][$i]['id'];?>"> 
                                <input type="hidden" name="name_item" 
                                value="<?php echo $data["items"][0][$i]['name'];?>">
                                <input type="radio" name="value" id="ra_item"
                                value="1">
                                <input type="radio" name="value" id="ra_item"
                                 value="2">
                                <input type="radio" name="value" id="ra_item"
                                ...
                                value="5">
                                 ...
                                 <input type="submit" 
                                 data-id="<?php echo $data["items"][0][$i]['id'];?>"
                                 name="rate" 
                                 id="rate_rate" class="rate3 rate_rate" value="Rate">
                        ...
                        <!--form begins-->
                             ...
                             <form action="#" method="post">
                                ...
                                <input type="submit"
                                 name="addCart" id="addCart" class="addCart"
                                 data-id="<?php echo $data["items"][0][$i]['id'];?>"
                                 data-image="<?php echo $data["items"][0][$i]['image'];?>"
                                 data-name="<?php echo $data["items"][0][$i]['name'];?>"
                                 data-price="<?php echo $data["items"][0][$i]['price'];?>"
                                 data-quantity="1"
                                 value="Add to cart">
